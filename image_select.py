...
def asymmetric_generalized_gaussian(x, nu, sigma_l, sigma_r):
    ...
    def f(x, sigma): return coefficient * np.exp(-(x / beta(sigma)) ** nu)
...
root_path = "/media/florestan/BACKUP/copy to new J/AUFTRÄGE/Georgia&Jan/JPEG/_DSC0143.jpg"
trash_path = "./trash/"
